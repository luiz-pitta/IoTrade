...
public abstract class ChartUtils {
    ...
    public static final int COLOR_YELLOW = Color.parseColor("#cc9900");
    public static final int COLOR_DARK_BLUE = Color.parseColor("#006699");
    public static final int COLOR_GREY = Color.parseColor("#999966");
    public static final int COLOR_WINE = Color.parseColor("#990033");
    public static final int[] COLORS = new int[]{COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE, COLOR_RED, COLOR_YELLOW, COLOR_DARK_BLUE, COLOR_GREY, COLOR_WINE};
